...
public class DPK11Impl8 {

    private TokenMatcher tokenMatcher;

    public DPK11Impl8(TokenMatcher tokenMatcher) {
    ...
    public static void main(String[] args) {
        System.out.println("--> DPK 11 - Implementation 08 <--");
        DPK11Impl8 dpk11Impl8 = new DPK11Impl8(new ExactTokenMatcher());

        var input1 = "Hello,World,How,Are,You";
        var result1 = dpk11Impl8.replace(input1, ",", "-");
        System.out.println("replace(\"Hello,World,How,Are,You\", \",\", \"-\") -> " + result1);

        var result2 = dpk11Impl8.replace(input1, ",World,", "-");
        result2 = dpk11Impl8.replace(result2, ",", "-");
        System.out.println("replace(\"Hello,World,How,Are,You\", \",World,\", \"-\") -> " + result2);

        dpk11Impl8.setTokenMatcher(new DelimitedTokenMatcher());
        var result3 = dpk11Impl8.replace(input1, ",World,", "-");
