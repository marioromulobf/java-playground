...
public class DPK12Impl5 {
    ...
    public static void main(String[] args) {
        System.out.println("--> DPK 12 - Implementation 05 <--");
        DPK12Impl5 dpk12Impl5 = new DPK12Impl5();

        var input1 = new ArraySortable(new int[]{5,4,3,2,1});
        System.out.print("bubbleSort(" + input1 + ") -> ");
        var startTime = System.nanoTime();
        dpk12Impl5.bubbleSort(input1);
