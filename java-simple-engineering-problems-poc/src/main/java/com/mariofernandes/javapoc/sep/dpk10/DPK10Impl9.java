...
public class DPK10Impl9 {
    ...
    public static class ArrayFlow<I> implements Flow<I> {
    ...
    public static class CollectionFlow<I> implements Flow<I> {
    ...
    public static void main(String[] args) {
        System.out.println("--> DPK 10 - Implementation 09 <--");
