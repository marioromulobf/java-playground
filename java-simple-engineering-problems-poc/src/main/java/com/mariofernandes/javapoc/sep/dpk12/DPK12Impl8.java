...
public class DPK12Impl8 {
    ...
    static class ListSortable<T> implements Sortable<T> {
    ...
    public<T> void bubbleSort(Sortable<T> items, Comparator<T> comparator) {
        ...
        for (int end = items.size() - 1; end > 0; end--) {
            ...
            for (int i = 0; i < end; i++) {
                if (comparator.greaterThan(items.get(i), items.get(i + 1))) {
                    items.swap(i, i + 1);
    ...
    public static void main(String[] args) {
        System.out.println("--> DPK 12 - Implementation 08 <--");
        DPK12Impl8 dpk12Impl8 = new DPK12Impl8();

        var input1 = Sortable.from(new Integer[]{5,4,3,2,1});
        System.out.print("bubbleSort(" + input1 + ") -> ");
        var startTime = System.nanoTime();
        dpk12Impl8.bubbleSort(input1, (a, b) -> a > b);
        ...
        dpk12Impl8.bubbleSort(input2, (a, b) -> a > b);
        ...
        startTime = System.nanoTime();
        dpk12Impl8.bubbleSort(input3, (a, b) -> a > b);
        endTime = System.nanoTime();
        ...
        startTime = System.nanoTime();
        dpk12Impl8.bubbleSort(input4, (a, b) -> a > b);
        endTime = System.nanoTime();
