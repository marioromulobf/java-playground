...
public class DPK14Impl4 {
    ...
    public static void main(String[] args) {
        System.out.println("--> DPK 14 - Implementation 04 <--");
        DPK14Impl4 dpk14Impl4 = new DPK14Impl4();
        ...
        printGrid(grid);
        var result = dpk14Impl4.move(grid, initialPosition, moves);
