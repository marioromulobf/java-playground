# Problem
This is a table test for *DPK09 - Filter*:
...
**The filter function should receive a collection(list or array) and a function that will be applied to each element of the collection.**
