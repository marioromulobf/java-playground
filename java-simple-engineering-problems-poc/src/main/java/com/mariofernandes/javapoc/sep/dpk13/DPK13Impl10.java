...
public class DPK13Impl10 {
    ...
    public static List<Object> fizzbuzz(int size) {
        validate(size);
        updateCache(size, DPK13Impl10::convert);
