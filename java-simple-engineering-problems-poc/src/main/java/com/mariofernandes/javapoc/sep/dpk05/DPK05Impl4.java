...
public class DPK05Impl4 {
    ...
    private final Map<Integer, Runnable> matchActions = Map.of(
            3, this::resetGame
    );
    ...
    public String play(String playerOne, String playerTwo) {
        ...
        matchesPlayed++;
        matchActions.getOrDefault(matchesPlayed, () -> {}).run();

        return winner;
    }

    public static void main(String[] args) {
        System.out.println("--> DPK 05 - Implementation 04 <--");
        DPK05Impl4 dpk05Impl4 = new DPK05Impl4();

        var winner1 = dpk05Impl4.play(DPK05Impl4.PLAYERS[0], DPK05Impl4.PLAYERS[1]);
        var winner2 = dpk05Impl4.play(DPK05Impl4.PLAYERS[2], DPK05Impl4.PLAYERS[3]);
        dpk05Impl4.play(winner1, winner2);
        dpk05Impl4.play(DPK05Impl4.PLAYERS[0], DPK05Impl4.PLAYERS[1]);
    }
}
